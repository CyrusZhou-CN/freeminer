...
void init(MapgenEarth *mg)
{
    ...
    MUD_BRICK_SLAB = def;
    BRICK_SLAB = def;
    POTTED_RED_TULIP = def;
    POTTED_DANDELION = def;
    POTTED_BLUE_ORCHID = def;
    
    // Initialize missing blocks
    BARREL = def;
    FERN = GRASS;
    CHIPPED_ANVIL = ANVIL;
    LARGE_FERN_LOWER = GRASS;
    LARGE_FERN_UPPER = GRASS;
